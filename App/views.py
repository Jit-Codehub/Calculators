  ...
  if a == None:
    ...
    try:
      ...
      if a in range(1,11):
        ...
        l = [91, 92, 93, 94, 95, 96, 97, 98, 99, 100]
      print(l)
      return render(request,"subtractiontablegeneratorcalculator.html",{"a":a,"b":l})
    except:
      return render(request,"subtractiontablegeneratorcalculator.html",{"a":7})
  ...
  if a == None:
    ...
    try:
      ...
      if a in range(1,11):
        ...
        l = [91, 92, 93, 94, 95, 96, 97, 98, 99, 100]
      print(l)
      return render(request,"multiplicationtablegeneratorcalculator.html",{"a":a,"b":l})
    except:
      return render(request,"multiplicationtablegeneratorcalculator.html",{"a":11})
...
def additionURL(request, a=7):
  ...
  if a in range(1,11):
    ...
    l = [91, 92, 93, 94, 95, 96, 97, 98, 99, 100]
  return render(request,"additionURL.html",{"a":a,"b":l})





def multiplicationURL(request, a=11):
  if a == "00":
    a = 1
  return render(request,"multiplicationURL.html",{"a":int(a)})

def subtractionURL(request, a=7):
  return render(request,"subtractionURL.html",{"a":int(a)})

def divisionURL(request, a=11):
  if a == "00":
    a = 1
  return render(request,"divisionURL.html",{"a":int(a)})
